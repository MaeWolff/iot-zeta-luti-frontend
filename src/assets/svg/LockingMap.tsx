...
const Rect = styled.rect<{isOpen?: boolean}>`
    fill: ${({isOpen}) => isOpen ? "#15DD41" : "#CB3636"};
    stroke: #231f20;
...
export default function Map() {
    return (
        <SvgStyled  id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 855 848.66">
            ...
            <Rect id='C001' x="5.5" y="5.5" isOpen width="288.08" height="167.53" />
            <Rect id='C001' x="5.5" y="173.03" width="288.08" height="167.53" />
            <Rect id='C005' x="561.42" y="173.03" isOpen width={288.08} height={167.53} />
            <Rect id='B001' x="514.44" y="340.57" isOpen width="335.07" height="167.53" />
            <Rect id='B003' x="514.44" y="675.63" width="335.07" height="167.53" />
            <Rect id='B002' x="514.44" y="508.1" isOpen width="335.07" height="167.53" />
            <Rect id='A003' x="5.5" y="675.63" width="335.07" height="167.53" />
            <Rect id='A002' x="5.5" y="508.1" width="335.07" height="167.53" />
            <Rect id='A001' x="5.5" y="340.57" isOpen width="335.07" height="167.53" />
            <Rect id='C001' x="293.58"  isOpen  y="5.5" width="267.83" height="167.53" />
